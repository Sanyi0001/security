...
@section('body')
    <div id="wrapper">
        <div id="page">
            <h1 class="underline text-green-600 text-xl font-extrabold">New Car</h1>
            <form method="POST" action="{{route('cars.index')}}">
                @csrf
                <div class="field">
                ...
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input {{$errors->has('manufacturer') ? 'is-danger' : ''}}" type="text"
                               name="manufacturer" id="manufacturer" value="{{old('manufacturer')}}">
                        @error('manufacturer')
                ...
                <div class="field">
                    ...
                    <select class="input {{$errors->has('currently_available') ? 'is-danger' : ''}}" type="select"
                            name="currently_available" id="currently_available" value="{{old('currently_available')}}">
